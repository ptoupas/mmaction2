...
log_level = 'INFO'
# work_dir = f'./work_dirs/x3d_m_certhbot_har/x3d_m_16x5x1_facebook_certhbot_rgb_v13_bbox_split_{split}'
work_dir = f'./work_dirs/x3d_m_certhbot_har_MSRDailyActivity3D_NTU_RGB/x3d_m_16x5x1_facebook_certhbot_rgb_v3_bbox_split_{split}'
workflow = [('train', 1)]
...
# load_from = f'work_dirs/x3d_m_certhbot_har/x3d_m_16x5x1_facebook_certhbot_rgb_v12_split_{split}/epoch_60.pth'
load_from = f'work_dirs/x3d_m_certhbot_har_MSRDailyActivity3D_NTU_RGB/x3d_m_16x5x1_facebook_certhbot_rgb_v2_split_{split}/epoch_60.pth'
resume_from = None
