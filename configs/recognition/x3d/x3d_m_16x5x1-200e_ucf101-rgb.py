...
model = dict(
    ...
    cls_head=dict(num_classes=101, dropout_ratio=0.5, average_clips='prob'))
...
data_root = '/second_ext4/ptoupas/data/ucf101/'
data_root_val = '/second_ext4/ptoupas/data/ucf101/'
...
work_dir = f'/second_ext4/ptoupas/mmaction2/work_dirs/x3d_m_ucf101/x3d_m_16x5x1-{epochs}e_ucf101-split_{split}_v{version}'
